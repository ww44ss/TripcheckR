...
This analysis is based on data pulled from the Oregon Dept of Transportation (ODOT) TripCheck feed on twitter. It uses a separate program to download the data from the feed (TwitterReader) available in my github repository, which stores the feed data in a local .csv file.


It plots a timeline of specific events and does a histogram and density anlaysis. 
