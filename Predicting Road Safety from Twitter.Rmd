...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
        ...
        f<-glm(Accident~Snow + factor(weekday), family=binomial, datecortab)
...
Hence according to the regression model `r exp(coef(f)[2]-coef(f)[1])` is the reduction in odds from snow to no snow.  
