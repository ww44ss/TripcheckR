...
```{r "clean", echo=FALSE, warning=FALSE}
        ...
        hwy_snow <-hwy_df[grep(metaincident, hwy_df$text),]
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
        ...
        datecortab$Snow <- datecortab$date%in%hwy_snow$created
