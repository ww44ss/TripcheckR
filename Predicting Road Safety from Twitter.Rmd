...
```{r}
        ...
        hwy_df$hourdelta[1:10]
        tail(hwy_df$hourdelta)
...
```{r "clean", echo=FALSE, warning=FALSE}
        ...
        ##dedup the data
        ## do this because not possible to tell whether there are multiple tweets from same crash
        hwy_df<-hwy_df[!duplicated(hwy_df$date),]
