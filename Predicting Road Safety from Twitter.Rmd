...
```{r echo=FALSE}
        ...
        hwy_df$chronsecs[1:10]


        ### capture start adn edn times of period 
...
```{r, echo=FALSE}        
        f<-glm(Accident~Snow+weekday, family=binomial, datecortab)
...
p1 <- ggplot(hwy_df, aes(date,hour)) + geom_point(color= "red")
...
tt<-hwy_df[hwy_df$hour<2|hwy_df$hour>22,]

tt[1:20, c("created", "text", "hour", "hourdelta")]
