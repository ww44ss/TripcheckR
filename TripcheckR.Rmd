---
title: "TripCheckR - Automobile Accident Probabilities and Prediction from Twitter"
...
This analysis uses data from the [Oregon Dept of Transportation](https://tripcheck.com/Pages/Twitter.asp) Tripcheck twitter feeds. 

The analysis focuses on a specific location, US Highway 20, over Santiam Pass, a 4800 foot (1450 meters) mountain pass in the Cascade Range. As the main route from Bend, Oregon to the Willamette Valley cities of Portland, Eugene, and Salem, it has high traffic year round and is the site of [frequent accidents](http://www.nuggetnews.com/archives/960717/front1.shtml)

This analysis focuses on the correlation of snow and ice to traffic accidents on the pass. Using Bayesian analysis, we examine the question, given an accident occurs, what is the probability snow conditions existed. 
...
abline(h=0,lwd=3,col="cornsilk4")
...
##add y-axis numbers
text(rangeYM[1]-20, 0, "0")
text(rangeYM[1]-20, 2, "2")
text(rangeYM[1]-20, 4, "4")
text(rangeYM[1]-20, 6, "6")
text(rangeYM[1]-20, 8, "8")
text(rangeYM[1]-20, -2, "-2")
text(rangeYM[1]-20, -4, "-4")
...
title(main=paste(location, file_name, "data"), ylab="miles", xlab="data (yyyy-mm)")
...
The mean distance of accidents is `r mean(plotdata$distance)` with a standard deviation of `r sd(plotdata$distance)`.
