...
This compares to the total number of crashes `r TotalCrashes` reported along the 123 miles of highway covered by the `r file_name` data or `r 52*7 * (TotalCrashes)/as.numeric((rangeYM[2]- rangeYM[1]))/123`  accident/year/mile.
